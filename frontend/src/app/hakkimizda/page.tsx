      ...
      >
        ...
        <section>
          ...
          <p>
            ...
            kütüphanesi yer almaktadır. Bu ileri seviye matematiksel modelleme sayesinde trend analizi, gelecek öngörüleri ve hata payı metriklerini şeffaf bir şekilde sunuyoruz.
          </p>
        </section>
        ...
        <section className="!mt-14 rounded-2xl border border-amber-500/20 bg-amber-500/5 px-5 py-5 md:px-6">
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-white/75">
            FinanceScout bir demo ve öğrenme platformudur. Sunulan analizler tamamen algoritmik modellerin çıktılarıdır ve kesinlikle <strong className="text-white">yatırım tavsiyesi niteliği taşımaz</strong>.
          </p>
        </section>
      </SimpleArticle>
